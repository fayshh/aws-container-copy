...
# __generated__ by Terraform from "us-east-1_IUOHYHuoh/1e68c4ld54ikkdo5rj3jl9e802"
...
# __generated__ by Terraform from "us-east-1_IUOHYHuoh"
resource "aws_cognito_user_pool" "xpix" {
  alias_attributes           = null
  auto_verified_attributes   = ["email"]
  deletion_protection        = "ACTIVE"
  mfa_configuration          = "OFF"
  name                       = "User pool - mnbpzr"
